...
def create_hold_transaction_items(
    event_id: str, holding_id: str, user_id: str, seats: list, ttl: int = 180
) -> list:
    ...
    for seat_pos in seats:
        seat_item = {
            "Update": {
                "TableName": db_client.table_name,
                "Key": {"pk": {"S": event_id}, "sk": {"S": seat_pos}},
...
def create_booking_transaction_items(
    event_id: str,
    booking_id: str,
    holding_id: str,
    user_id: str,
...
def create_enhanced_booking_transaction_items(
    event_id: str,
    booking_id: str,
    holding_id: str,
    user_id: str,
    ...
    holding_delete_item = {
        "Delete": {
            "TableName": db_client.table_name,
            "Key": {"pk": {"S": event_id}, "sk": {"S": holding_id}},
            "ConditionExpression": "holding_id = :holding_id",
            "ExpressionAttributeValues": {":holding_id": {"S": holding_id}},
        }
    }
...
def create_cancellation_transaction_items(
    event_id: str, booking_id: str, seats: list
) -> list:
...
def create_enhanced_cancellation_transaction_items(
    event_id: str, booking_id: str, seats: list, booking_sk: str
) -> list:
    ...
    booking_update_item = {
        "Update": {
            "TableName": db_client.table_name,
            "Key": {"pk": {"S": event_id}, "sk": {"S": booking_sk}},
