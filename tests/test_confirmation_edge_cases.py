...
class TestConfirmationEdgeCases:
    ...
    def test_double_confirmation_attempt(self, test_setup):
        ...
        confirm_response2 = client.post(f"/{holding['holding_id']}/confirm", json=confirm_data)
    ...
    def test_confirmation_after_seat_booking(self, test_setup):
        ...
        confirm_response1 = client.post(f"/{holding1['holding_id']}/confirm", json=confirm_data)
