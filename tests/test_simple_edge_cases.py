...
class TestSimpleEdgeCases:
    ...
    def test_hold_seats_success(self, test_setup):
        ...
        hold_response = client.post(f"/events/{test_setup['event']['event_id']}/hold", json=hold_data)
    ...
    def test_hold_already_held_seats(self, test_setup):
        ...
        hold_response1 = client.post(f"/events/{test_setup['event']['event_id']}/hold", json=hold_data1)
        ...
        hold_response2 = client.post(f"/events/{test_setup['event']['event_id']}/hold", json=hold_data2)
    ...
    def test_confirm_nonexistent_holding(self, test_setup):
        ...
        confirm_response = client.post("/nonexistent-holding-id/confirm", json=confirm_data)
    ...
    def test_hold_expiration_after_time(self, test_setup):
        ...
        hold_response2 = client.post(f"/events/{test_setup['event']['event_id']}/hold", json=hold_data)
